              ...
              return IconButton(
                ...
                onPressed: () {
                  if (authState.isAuthenticated) {
                    _showProfileSheet(context, authState);
                  } else {
                    context.push('/login');
                  }
                },
                tooltip: authState.isAuthenticated ? 'Profil' : 'Masuk',
              );
            },
          ),
        ],
                      ...
                      builder: (context, constraints) {
                        ...
                        if (isWide) {
                          ...
                          return GridView.builder(
                            controller:
                                _scrollController, // Controller tetap sama
                            gridDelegate:
                                SliverGridDelegateWithFixedCrossAxisCount(
                                  crossAxisCount: crossAxisCount,
                                  childAspectRatio:
                                      0.65, // Rasio item (sesuaikan)
      ...
      builder: (_) {
        return Padding(
          ...
          child: Column(
            ...
            children: [
              Text('Akun Saya', style: Theme.of(context).textTheme.titleLarge),
              SizedBox(height: 2.h),
              ListTile(
                ...
                leading: CircleAvatar(
                  ...
                  child: Text(
                    (user?.displayName ?? user?.email ?? 'U').characters.first
                        .toUpperCase(),
                    style: const TextStyle(fontWeight: FontWeight.bold),
                  ),
                ),
                title: Text(user?.displayName ?? 'Pengguna Streamime'),
                ...
                child: Hero(
                  ...
                  child: Image.network(
                    ...
                    errorBuilder: (context, error, stackTrace) => Container(
                      ...
                      child: Center(child: Icon(Icons.broken_image, size: 8.w)),
                    ),
                  ),
                ),
              ),
